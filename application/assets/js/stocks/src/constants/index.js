...
export const FIN_1 = ["Zlato", "Kuća", "Obveznica", "Novac na tekućem racunu", "Ne znam"];
export const FIN_2 = ["Oročeni depozit", "Akcija", "Obveznica", "Štedni depozit", "Ne znam"];
export const FIN_3 = ["Rizik se smanjuje", "Rizik se povećava", "Rizik ostaje nepromenjen", "Ne znam"];
export const FIN_4 = ["Cena obveznica pada", "Cena obveznica raste", "Cena obveznica ostaje nepromenjena", "Ne znam"];
export const FIN_5 = ["Više nego danas", "Manje nego danas", "Isto kao i danas", "Ne znam"];
export const FIN_6 = ["Više nego danas", "Manje nego danas", "Isto kao i danas", "Ne znam"];
...
export const FIN_12 = ["Ne možete povući svoj novac u prvoj godini.", "Investicioni fondovi ulažu u više od jedne investicione opcije (kao što su akcije i obveznice).", "Investicioni fondovi nude zagarantovane stope prinosa na bazi prethodnih ulaganja.", "Ništa od navedenog.", "Ne znam"];
